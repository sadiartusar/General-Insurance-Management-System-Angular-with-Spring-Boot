...
INSERT INTO `bills` VALUES (1,10,295048.6,256564,10,0.15,1),(2,15,13800,12000,0,0.15,2);
/*!40000 ALTER TABLE `bills` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `car_policy`
--
...
--
-- Dumping data for table `car_policy`
--

LOCK TABLES `car_policy` WRITE;
/*!40000 ALTER TABLE `car_policy` DISABLE KEYS */;
/*!40000 ALTER TABLE `car_policy` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cars` VALUES (1,'sgsdff','Islami Bank','2nd class','Engine Damage Only','2025-08-13','gfdsg','fdssdf','Reja','2025-08-13','2026-08-13','Reja Car House','Engine',1233424,'Godown Only'),(2,'Fdg','Pubali Bank','2nd class','Engine Damage Only','2025-08-13','gfdbhf','sfdg','Rohim','2025-08-13','2026-08-13','RohimCar House','dgdfg',1212,'Godown Only');
...
INSERT INTO `moneyreceipts` VALUES (1,'Fire Insurance','2025-08-13','dfsdgbdf','Dhaka','Cash',1);
...
INSERT INTO `policies` VALUES (1,'fhxdbf','dzgsxdg','2nd class','Fire & Lightning Only','2025-08-13','dfhgh','fghnjfgj','gcvnjhfgj','2025-08-13','2026-08-13','cfgnjcgn','cdfhdfh',23324,'Shop Only'),(2,'Lalbag','Pubali Bank','2nd class','Fire & Lightning Only','2025-08-13','ffdh','Lalbag, 12','Rakib','2025-08-13','2026-08-13','Rakib Food Hose','Food',12000,'Shop Only');
...
-- Dump completed on 2025-08-13 18:59:38
